...
import argparse
from model import model_t_y_dis_rep_3_weight
...
def train(path, args, address):
    ...
    net = model_t_y_dis_rep_3_weight.net(args).to(args.device)
...
if __name__ == '__main__':
    ...
    train(path ='save/notopk_subipc/42/weight/400_0.2068046774207191_0.2068046774207191.pth', args=args, address='za_42/')
